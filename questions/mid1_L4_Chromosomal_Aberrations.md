...
Unbalanced
Balanced 
There is loss or gain of chromosomal 
material
The chromosome set has the normal 
complement ,no loss or gain
The phenotype is likely to be
abnormal 
Don’t usually have phenotypic effect 
But they can pose a threat to the 
offspring  
Delet...

**Q2.** Which of the following terms describes the inheritance of two different
homologous chromosomes from the same parent?
...
Discuss the abnormalities on a given karyotype
for a common condition
Outline the clinical implications of abnormal
karyotype
...
**Q3.** Loss of the paternal chromosome segment 15q11–q13 leads to which
condition?
...
**Q4.** When breaks occur on each arm of a chromosome and the
segment between the breaks is
reconstituted, which type of chromosome rearrangement is
this?
...
**Answer:** B
**Explanation:** From L4 Chromosomal Aberrations: Inversions 
Can occur when a single chromosome undergoes 2
breaks
and
is
reconstituted
...
the
segment
between the breaks inverted.

**Q5.** Which of the following is most commonly detected by
cytogenetic testing?
...
**Q6.** What is the most common cause of triploidy?
...
Polyploidy
The karyotype with any multiple of the basic
haploid (n) other than the normal diploid (2n)
Two polyploidy condition occur in humans:
Triploidy (3n) with ...

**Q7.** What is the most common cause of Turner syndrome?
...
**Answer:** B
**Explanation:** From L4 Chromosomal Aberrations: 46,XX,del(5)(p15)
...
**Q10.** What is the term used to describe a double break in the short
arm of a chromosome and replaced in the region between the
breaks inverted?
...
abnormalities 
Chromosome report reading 46,XY,t(2;4)(p23;q25) :
Male with a reciprocal translocation between chr 2 and chr 4 
involving short arm of chr 2 at region 2 band 3 and long arm 
of chr 4 at region 2 band 5 
Chromosome report read...

**Q11.** which of the following represents delation of short in arm of
chromosome 10 in male
...
**Q15.** A 6-year-old male patient with seizure, intellectual disability,
inappropriate laughter, microocephaly, unsteady gait, what is the
most likely genetic mechanism?
...
**Q17.** Majed, 30 years old, went to the genetic clinic, married for three
years, and sterile due to azoospermia, the family history was
negative, and his characteristics were tall and his arms were long.
...
**Answer:** B
**Explanation:** From L4 Chromosomal Aberrations: 47,XX,+21 Standard Down Syndrome 
...
Congenital heart disease, e.g. Monosomy for an entire chromosome is
...
**Q20.** In the following diagram, what chromosomal abnormality is shown?
...
**Q24.** What is the indication when a normal parent has a child with
malformations and an unbalanced chromosomal abnormality?
...
**Q25.** What is the diagnosis of the
 following karyogram?
...
**Q28.** 4. ............ involves 2 Acrocentric chromosomes fuse near the centromere and loss
their short arm
...
**Q29.** The following karyotype is for:
...
**Answer:** B
**Explanation:** From L4 Chromosomal Aberrations: Numerical Chromosome Abnormalities
...
features, including almond-shaped eyes and small hands and feet.
...
**Q31.** A male presents with dysmorphic facial features, almond-
shaped eyes, small hands and feet, hyperphagia, short stature, and
obesity. What is the most likely diagnosis?
...
**Q33.** A karyotype shows a ring X chromosome. Identify the disorder:
...
**Q34.** The following karyotype is for:
...
**Q36.** This karyotype is diagnosed for:
...
**Q38.** Mustafa and Fatima are a couple seeking genetic counseling. They have a male
baby with a chromosomal aberration: 46,XY,t(21;21)+21. Cytogenetic analysis for

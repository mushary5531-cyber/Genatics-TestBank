**Q1.** A 2-year-old child has developmental delay and multiple congenital
anomalies. Chromosome analysis and microarray are negative, and no specific
syndrome is suspected. What is the most appropriate next test?
...
genome, coding and noncoding regions (i.e., exons + introns)


4/6/26
20
Whole Genome Sequencing (WGS)
• WGS is also performed via NGS but 
does not require the targeted sequence 
capture step, as in WES and targeted 
panels
• Able to de...

**Q2.** A woman with breast cancer is found to carry a pathogenic CHEK2 variant.
Which test is most appropriate to screen her siblings for the same mutation?
...
**Q5.** Sara is a 30 years old female who came to a genetic
counseling with a history of breast cancer in family. Her mother
had breast cancer caused by BRCA1. Which of the following tests is
appropriate for sara?
...
**Q6.** A 47-year-old female patient is referred to the genetic clinic,
tumor in her right colon. Her father died at the age of 55 from colon
cancer, her paternal aunt had endometrial cancer. What is the
best technique to confirm her condition?
...
**Answer:** A
**Explanation:** From L13 Molecular Techniques: Confirmation a de novo mutation in a patient (by testing the mutation in 
the parent)
...
15
Sanger Sequencing
Examples of diseases which can be diagnosed 
with Sanger Sequencing: Cystic Fibrosis 
(CF)
Responsible gene: CFTR (cystic fibrosis transmembrane 
...
involves mixing DNA from two sources that have been denatured by heat 
or alkali to make them single-stranded and then, under the appropriate 
conditions, allowing complementary base pairing of homologous 
sequences to identify a specific DNA sequences
Molecular Methods
•...

**Q8.** Which of the following methods is used for separation of DNA
fragments?
...
**Answer:** C
**Explanation:** From L13 Molecular Techniques: -
It is a variation of the multiplex PCR 
that permits amplification of multiple 
targets with only a single primer
...
4/6/26
12
Example of disease which can be diagnosed 
with MLPA: 
